...
#PBS -N 0134
#PBS -v RTYPE=rt_HF
#PBS -l select=4:ncpus=8:mpiprocs=8:ngpus=8
#PBS -l walltime=168:00:00
#PBS -j oe
#PBS -koed
#PBS -V
#PBS -o outputs/optimal-sparsity-math-d512-E8-k4-320M-A220M
#PBS -m n

cd $PBS_O_WORKDIR

EXP_NAME="optimal-sparsity-math-d512-E8-k4-320M-A220M"
