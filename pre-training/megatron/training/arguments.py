...
def _add_learning_rate_args(parser):
    ...
    group.add_argument(
        '--lr-scale-final-layernorm',
        type=float,
        default=1.0,
        help='Learning rate multiplier for final layer normalization',
    )
    group.add_argument(
        '--lr-scale-expert',
        type=float,
        default=1.0,
        help='Learning rate multiplier for expert layers (mlp.experts.linear_fc1/fc2)',
    )
    group.add_argument(
        '--lr-scale-shared-expert',
        type=float,
        default=1.0,
        help='Learning rate multiplier for shared expert layers (mlp.shared_experts.linear_fc1/fc2)',
    )
    group.add_argument(
        '--lr-scale-gate',
        type=float,
        default=1.0,
        help='Learning rate multiplier for gating/router layers (mlp.router)',
    )
    group.add_argument(
        '--lr-scale-pre-layernorm',
        type=float,
        default=1.0,
        help='Learning rate multiplier for pre-MLP layer normalization',
    )
    group.add_argument(
        '--lr-scale-attention-proj',
        type=float,
        default=1.0,
        help='Learning rate multiplier for attention projection layer',
    )
    group.add_argument(
        '--lr-scale-qkv-layernorm',
        type=float,
        default=1.0,
        help='Learning rate multiplier for QKV layer normalization',
    )
    group.add_argument(
        '--lr-scale-qkv',
        type=float,
        default=1.0,
        help='Learning rate multiplier for QKV transformation layer',
    )
    group.add_argument(
        '--lr-scale-embedding',
        type=float,
        default=1.0,
        help='Learning rate multiplier for embedding layer',
    )
    group.add_argument(
        '--lr-scale-final-linear',
        type=float,
        default=1.0,
        help='Learning rate multiplier for final output layer',
    )
